...
export class IBallotForm extends React.PureComponent<{}, IBallotFormState> {
  ...
  public render() {
    ...
    <>
        ...
        <ul>
          <li>In order to protect personal information, the votes are counted anonymously after identification.</li>
          <li>please take care not to include any personally identifiable information in the comments section, such as your name, email address, or phone number</li>
          <li>After you have voted, you are free to deregister to vote by contacting the Registrar of Voters</li> 
          <li>If you are found to have voted more than once, your vote will be recorded as fraudulent. Deletion of your account will not remove this record.</li> 
        </ul>
        <br/>
      <FormGroup>
        ...
        <TextArea onChange={this.onCommentUpdate} growVertically={true} value={comments} fill={true} placeholder="Comments or concerns. Do not include any personally identifiable information." />
      </FormGroup>
  ...
  private onVoteSubmission = async (event: React.MouseEvent<HTMLElement>) => {
    ...
    if (!response.ok) {
      ...
      toaster.show({
        message: "Your vote was successful. If you wish to void your vote, please contact the voter registrar.",
