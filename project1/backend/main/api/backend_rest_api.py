...
def populate_database():
    ...
    voter= Voter("bamuse","fukuhara","19681023")
    registry.register_voter(voter)
    first_ballot=balloting.issue_ballot(voter.national_id)
    print("your first ballot number",first_ballot)
    
    second_ballot=balloting.issue_ballot(voter.national_id)
    print("your second ballot number",second_ballot)
